...
const PlevicFloorBanner = ({banner}) => {
  return (
    <section>
        <div className='max-w-[1600px] bg-[] m-auto overflow-hidden'>
            <div className='grid lg:grid-cols-3 mt-35 w-[95%] m-auto'>
                <div className='flex flex-col  lg:col-span-2 order-2 lg:order-1 mt-4 lg:mt-0'>
                  <h1 className='font-[Raleway] smallShadow lg:textShadow  text-center lg:text-start text-2xl sm:text-4xl lg:text-6xl font-bold mt-2 lg:mt-30'>{banner?.Heading}</h1>
                  <p className='font-[Raleway] text-base sm:text-xl text-center lg:text-start w-[100%] lg:w-[90%] mt-8'>{banner?.SubHeading}</p>
                ...
                <div className='bg-[]  flex justify-center lg:justify-end items-center order-1 lg:order-2'>
                    <div className='bg-[] h-full w-full flex justify-center items-center '>
                        <img src={banner?.Image} alt='' className='bg-[] h-70 lg:h-full' />
                    </div>
                </div>
