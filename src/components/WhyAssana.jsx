...
const WhyAssana = ({whyAssanaComponentData}) => {


  return (
    <section className='max-w-[1600px] bg-[] m-auto overflow-hidden'>
      <div className='w-[95%] m-auto'>
        <h1 className='font-[Raleway] smallShadow lg:textShadow text-black text-center lg:text-start text-3xl sm:text-4xl lg:text-6xl font-semibold mt-2 lg:mt-30'>{whyAssanaComponentData?.leftHeading}</h1>

        <div className='flex flex-col justify-end items-center lg:items-end'>
            <h1 className='font-[Raleway] font-bold text-base sm:text-xl text-center lg:text-end mt-13'>{whyAssanaComponentData?.rightHeading}</h1>
             <h1 className='font-[Raleway] text-base sm:text-xl text-center lg:text-end w-[100%] lg:w-[70%] mt-4'>
             {whyAssanaComponentData?.rightPara}
            </h1>
        </div>
