...
const Banner = ({pilesorhaemorrhoids}) => {
  return (
    <section>
        <div className='max-w-[1600px] bg-[] m-auto overflow-hidden'>
            <div className=' mt-20 w-[95%] m-auto '>
                <div className='flex flex-col  lg:col-span-2 order-2 lg:order-1 mt-4 lg:mt-0 '>
                  <h1 className='font-[Raleway] smallShadow lg:textShadow  text-center  text-2xl sm:text-4xl lg:text-6xl font-bold mt-10 lg:mt-30 z-10'>{pilesorhaemorrhoids?.bannerHeading}</h1>
                  <p className='font-[Raleway] text-base sm:text-xl text-center  w-[100%] lg:w-[65%] mt-8 m-auto'>{pilesorhaemorrhoids?.bannerPara}</p>
